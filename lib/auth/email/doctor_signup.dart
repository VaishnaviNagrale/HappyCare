...
class DoctorEmailPassSignUp extends StatefulWidget {
  ...
  @override
  State<DoctorEmailPassSignUp> createState() => _DoctorEmailPassSignUpState();
}
...
class _DoctorEmailPassSignUpState extends State<DoctorEmailPassSignUp> {
  ...
  DiseaseType speciality = DiseaseType.Brain;
        ...
        child: Padding(
          ...
          child: ListView(
            children: [
              ...
              Container(
                margin: const EdgeInsets.symmetric(vertical: 10),
                child: DropdownButtonFormField<DiseaseType>(
                  value: speciality,
                  onChanged: (value) {
                    setState(() {
                      speciality = value!;
                  ...
                  items: DiseaseType.values.map((type) {
                    return DropdownMenuItem<DiseaseType>(
                      value: type,
                      child: Text(type.toString().split('.').last),
                    );
                  }).toList(),
